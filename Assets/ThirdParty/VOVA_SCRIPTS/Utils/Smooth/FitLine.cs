...
//		private FitMode _fitMode = FitMode.Quadratic;
//		private List<Vector3> _fitPoints;
//		private List<Vector3> _srcPoints;
//		private float _fitCoeff = 0.38f;
...
//		 */
//		public void FitLine(List<Vector3> points, float coeff = 0.38f, FitMode fitMode = FitMode.Quadratic)
//		{
//			_fitCoeff = coeff;
//			_fitMode = fitMode;
//			_srcPoints = points;
